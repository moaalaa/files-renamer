        ...
        @if (!!$this->files)
            ...
            <div class="fixed bottom-0 right-5 flex w-full items-center justify-end space-x-2 pb-5">
                ...
                <x-mary-popover>
                    ...
                    <x-slot:content>
                        Changing files names will prevent Sorting 🤡
                    </x-slot:content>
                </x-mary-popover>
                ...
                <x-mary-popover>
                    <x-slot:trigger>
                        <x-mary-button class="btn-circle btn-primary btn-lg" icon="o-pencil" wire:click="rename" spinner
                            responsive />
                    </x-slot:trigger>
                    <x-slot:content>
                        Rename
                ...
                <x-mary-popover>
                    <x-slot:trigger>
                        <x-mary-button class="btn-circle btn-error btn-lg" icon="o-folder-plus" link="/" spinner
                            responsive />
                    </x-slot:trigger>
                    <x-slot:content>
                        Open New Directory
